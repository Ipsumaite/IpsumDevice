...
import com.example.app_4.representation.Matrixf4x4;
...
public abstract class OrientationProvider implements SensorEventListener {
     ...
     */
    protected final com.example.app_4.representation.Matrixf4x4 currentOrientationRotationMatrix;

    /**
     * The quaternion that holds the current rotation
     */
    protected final com.example.app_4.representation.Quaternion currentOrientationQuaternion;
    ...
    public OrientationProvider(SensorManager sensorManager) {
        ...
        currentOrientationRotationMatrix = new com.example.app_4.representation.Matrixf4x4();

        // Initialise with identity
        currentOrientationQuaternion = new com.example.app_4.representation.Quaternion();
    }
     ...
     */
    public com.example.app_4.representation.Quaternion getQuaternion() {
        synchronized (syncToken) {
